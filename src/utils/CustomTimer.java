...
public class CustomTimer
{
    ...
    public void start() {
        ...
        timerFlag = true; // Ensure timer is active
    ...
    public synchronized void stop() {
        timerFlag = false; // Stop the timer flag
    ...
    public synchronized void setState(boolean timerFlag) {
     ...
     * Notes      : None.
     **/
    public synchronized void setMs(int ms) {
        time = ms;
    }
